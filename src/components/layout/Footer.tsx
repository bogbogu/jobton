...
const Footer = () => {
    return (
        <>
<section className="bg-blue-500 py-16 px-6 flex flex-col items-center">                <div className='flex flex-col items-center max-w-xl'>
  ...
  Join our newsletter and get practical advice to help you stay organized and land your next opportunity.
</p>
                    <NewsletterForm />                
                </div>
