...
const Metrics = () => {
  return (
    <>
      <section className="py-10 px-6 flex flex-col items-center dark:bg-slate-900 transition-colors duration-200">
        <div className="mb-8 flex flex-col items-center text-center">
          <h2 className="font-bold text-xl sm:text-2xl dark:text-white">How we're doing in Numbers</h2>
          <h3 className="text-slate-500 dark:text-slate-400 mt-2 max-w-lg mx-auto">
